  ...
  return (
    <div className="confirm-modal">
      ...
      <div className="confirm-modal__summary justify-content-start pl-2 pr-2 pt-2 pb-2">
        ...
        <div className="confirm-modal__summary__icon farms__stake-modal__icon-container">
          <div className="flex-center">
            <Image
              light={currentPool.coin_2.img}
              dark={currentPool.coin_2.img}
              alt={currentPool.coin_2.name}
              w="30"
              h="30"
            />
          </div>
        ...
        <div className="ml-1">
          ...
          <p className="font-size-24 font-weight-700 txt-uppercase">
            {currentPool.coin_1.name} - {currentPool.coin_2.name} LP
          </p>
        </div>
      </div>
      ...
      <div className="pl-2 pr-2">
        ...
        >
          <div className="txt-right">
            <p className="font-size-14 font-weight-700">{stakeAmount ? stakeAmount?.toFixed(18) : 0}</p>
          </div>
          <div className="txt-right">
