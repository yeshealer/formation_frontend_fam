...
const Box = ({ formTokenPrice = 0.03, box, farmType, farmName, isFarmActive }) => {
	...
	const mobileView = (
		<>
			...
			{account && isOpened && (
				<div className='d-flex flex-direction-column align-items-center pt-1 pb-2 pl-4 pr-4'>
					<p className='font-size-12 mb-1'>You have no liqudidity to stake.</p>
					<Button
						type='button'
						text='Add Liquidity'
						classes='w-100'
	...
	const desktopView = (
		<div className='farms__box__header'>
			...
			>
				...
				{isOpened ? (
					<div className='d-flex align-items-center justify-content-space-between pl-2 pr-1'>
						{account ? (
							<>
								<p className='font-size-12'>You have no liqudidity to stake.</p>
								<Button
									type='button'
									text='Add Liquidity'
									classes='pl-2 pr-2'
