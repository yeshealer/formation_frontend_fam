...
const Remove = () => {
  ...
  const remove = async () => {
    try {
      ...
      notify('success', 'Withdrew!', 'Funds were withdrew successfully');
      setTransactionStatus({
        type: TRANSACTION_ACTIONS.SEND,
    ...
    <div className="swapper">
      ...
      <div className="swapper__row">
        ...
        <div className="liquidity-tab__remove__boxes">
          <RemoveSummaryBox icon={token.icon} iconWidth={token.width} iconHeight={token.height} value={value} name={token.name} />
        </div>
      </div>
