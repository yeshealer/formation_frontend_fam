...
const ConfirmModal = ({ onCancel, handleSwap, srcSwapAmount = 0, destSwapAmount = 0, fee = 0 }) => {
  ...
  return (
    <div className="confirm-modal">
      ...
      <div className="confirm-modal__summary pt-2">
        <div className="flex-center">
      ...
      <div className="confirm-modal__footer">
        {CONFIRM_SWAP_INFO(from, to, fee?.toFixed(3)).map((item, idx) => renderInfoRow(item, idx))}
